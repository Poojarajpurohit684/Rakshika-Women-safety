...
import { Mail, Lock, Shield, ArrowRight, CheckCircle2, Loader2, Eye, EyeOff } from 'lucide-react'
      ...
      >
        <div className="text-center mb-8">
          ...
          <h1 className="text-4xl font-black tracking-tight leading-none mb-1">
            <span className="text-primary-content">Rakshi</span><span className="text-gradient">ka</span>
          </h1>
        ...
        <div className="glass-card !rounded-[1.75rem]">
          <h2 className="text-lg font-bold text-primary-content mb-6">Sign in to your account</h2>

          <form onSubmit={onSubmit} className="space-y-5" noValidate>
            <div className="space-y-2">
              <label htmlFor="login-email" className="block text-xs font-semibold uppercase tracking-wider text-muted-content">
                Email
              </label>
            ...
            <div className="space-y-2">
              <label htmlFor="login-password" className="block text-xs font-semibold uppercase tracking-wider text-muted-content">
                Password
              </label>
              <div className="auth-field">
                <span className="auth-field__icon" aria-hidden>
        ...
        <div className="mt-7 text-center space-y-4">
          <p className="text-sm text-secondary-content">
            New to Rakshika?{' '}
            <Link to="/register" className="font-semibold transition-colors" style={{ color: '#ff4da6' }}>
              Create account
            </Link>
          </p>
